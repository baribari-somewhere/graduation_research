...
class Env_Comb_20230123_Output(gym.Env):
    ...
    def step(self, action_index: int):
        ...
        if self.playerQueue.queue[self.figure].victoryPoints >= self.maxPoints:
            ...
            # print("====================================================")
            print(f"playerA：{self.playerQueue.queue[0].victoryPoints}",end=",")
            print(f"playerC：{self.playerQueue.queue[2].victoryPoints}",end=",")

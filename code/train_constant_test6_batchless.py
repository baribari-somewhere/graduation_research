...
from env_constant_test_random_board2 import *
...
#env = Env_Catan()
# env = Env_Constant_Test3()
env = Env_Constant_Test_Random_Board2()
...
# model = DQN.load("./save_weights_test5_20230105/rl_model_44000000_steps.zip",
#                  env, verbose=0, tensorboard_log="log", device="auto")
model = DQN.load("./save_weights_test_random_20230113_test5_batchless/rl_model_12000000_steps.zip",
                 env, verbose=0, tensorboard_log="log", device="auto")
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_test_random_20230113_test5_batchless_conti12000000")

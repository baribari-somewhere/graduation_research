...
model = DQN("MlpPolicy", env, verbose=0, tensorboard_log="log",
            device="auto")
# model = DQN.load("./save_weights_test_random_20230113_zero/rl_model_12000000_steps.zip",
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_test_random_20230114_zero")

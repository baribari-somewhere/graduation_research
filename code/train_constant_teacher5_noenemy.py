...
from env_constant_catan_teacher5_noenemy import *
...
model = DQN.load("./save_weights_teacher5_noenemy_20230115/rl_model_16000000_steps",
                 env, verbose=1, tensorboard_log="log", device="auto")
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_teacher5_noenemy_20230115")

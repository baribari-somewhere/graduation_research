...
from env_constant_test4_get_resource_board import *
...
model = DQN.load("./save_weights_test4_get_resource_board_0115/rl_model_8000000_steps.zip",
                 env, verbose=1, tensorboard_log="log", device="auto")
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_test4_get_resource_board_0115_conti8000000")

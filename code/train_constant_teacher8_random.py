...
from env_constant_catan_teacher8_reward2n_random import *
...
#env = Env_Catan()
env = Env_Constant_Catan_Teacher8_Reward2n_Random()
...
for i in range(1000):
    ...
    #                      env, verbose=1, tensorboard_log="log", device="auto")
    model.learn(num)
    model.save(f"./tmp/teacher8_0128_random_dqn_{num*(i+1)}")
    # del model

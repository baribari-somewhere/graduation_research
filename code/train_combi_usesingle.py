...
model = DQN.load("./save_weights_constant2/rl_model_70000000_steps.zip",
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting_conti.default_save_freq, save_path="./save_weights_comb_usesingle_70000000/")

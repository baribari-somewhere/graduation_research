...
from env_comb_20230123_output import Env_Comb_20230123_Output
from ecc import *
import time
...
if len(sys.argv) > 1:
    ...
    # model = DQN.load(
    #     f"./save_weights_comb_20230126_typeB_2/rl_model_12000000_steps")
    model = DQN.load(
        f"./tmp/teacher8_0128_random_dqn_4000000")

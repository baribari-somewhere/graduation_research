...
class Env_Comb_Catan_conti(gym.Env):
    ...
    def step(self, action_index: int):
        ...
        for currPlayer in self.playerQueue.queue:
            ...
            if(currPlayer.name == 'player1' and self.half == False):
                ...
                reward = self.point
                # print(reward)
            elif(currPlayer.name == 'player3' and self.half == True):
                #print("player1 playing...")
                # print(f"self.change = {self.change}")
                # print(3)
                self.action_input(action, currPlayer)
            ...
            elif(currPlayer.name == 'player2' and self.half == False):
                # print(2)
            ...
            elif(currPlayer.name == 'player4' and self.half == True):
                # print(4)
                currPlayer.move(self.board)
                self.dicerolled = False
                self.half = False
            ...
            if(currPlayer.name == 'player4' and self.change == False):
                self.change = True
            elif(currPlayer.name == 'player4' and self.change == True):
                self.change = False

            if(currPlayer.name == 'player1' or currPlayer.name == 'player3'):
                if(currPlayer.victoryPoints == 5 and self.halfway == False):
                    self.point += 500000
                    self.falfway = True
            ...
            if currPlayer.victoryPoints >= self.maxPoints:
                ...
                if(self.game_count == 1):
                    f = open('result_comb_conti.txt', 'w')
                    f.write(f"{currPlayer.name}\n")
                else:
                    f = open('result_comb_conti.txt', 'a')
                    f.write(f"{currPlayer.name}\n")
                self.game_count += 1
    ...
    def build_initial_settlements(self):
        ...
        newPlayer = myAI('player3', 'magenta4')
        newPlayer.updateAI()
        self.playerQueue.put(newPlayer)
        self.player_set.append(newPlayer)

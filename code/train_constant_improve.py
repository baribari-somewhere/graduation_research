...
from env_constant_improve2 import *
import setting
import queue
import numpy as np
import sys
...
#env = Env_Comb_Catan()
env = Env_Constant_improve_Catan2()
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_constant_improve2")
...
eval_env = Env_Constant_improve_Catan2()

...
#             device="auto", learning_rate=0.000025)
print("hogehoge")
model=DQN.load("./save_weights_constant2/rl_model_70000000_steps.zip",env, verbose=1, tensorboard_log="log", device="auto")
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_test")

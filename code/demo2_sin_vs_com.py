...
from env_comb_20230123_output2 import Env_Comb_20230123_Output2
from ecc import *
import time
...
if len(sys.argv) > 1:
    ...
    model = DQN.load(
        f"./save_weights_comb_20230126_typeB_3/rl_model_28000000_steps")

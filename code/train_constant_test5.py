...
from env_constant_test_random_board import *
...
env = Env_Constant_Test_Random_Board()
...
model = DQN.load("./save_weights_test_random_20230111/rl_model_17000000_steps.zip",
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_test_random_20230111_conti17000000")

...
class Env_Constant_Catan_Teacher9_Reward2n(gym.Env):
    ...
    def step(self, action_index: int):
        ...
        self.choice = 0
        self.change = False
        self.vic_before = self.playerQueue.queue[0].victoryPoints
        ...
        for currPlayer in self.playerQueue.queue:
            ...
            if(currPlayer.name == 'player1'):
                ...
                # print(f"player1：{currPlayer.victoryPoints}")
                # print(f"player1_dev：{currPlayer.devCards}")
                ...
                reward = self.point
                if(currPlayer.victoryPoints == 3 and self.vic_before != 3):
                    reward += 1000
                elif(currPlayer.victoryPoints == 4 and self.vic_before != 4):
                    reward += 10000
                elif(currPlayer.victoryPoints == 5 and self.vic_before != 5):
                    reward += 100000
                elif(currPlayer.victoryPoints == 6 and self.vic_before != 6):
                    reward += 1000000
                elif(currPlayer.victoryPoints == 7 and self.vic_before != 7):
                    reward += 10000000
                elif(currPlayer.victoryPoints == 8 and self.vic_before != 8):
                    reward += 100000000
                elif(currPlayer.victoryPoints == 9 and self.vic_before != 9):
                    reward += 1000000000
                elif(currPlayer.victoryPoints >= 10 and self.vic_before != 10):
                    reward += 10000000000
            ...
            if currPlayer.victoryPoints >= self.maxPoints:
                # print([self.list1, self.list2, self.list3, self.list4,
                #       self.list5, self.list6, self.list7, self.list8])
                # print(self.playerQueue.queue[0].victoryPoints)
                # print(self.set_thing())
                ...
                if(self.game_count == 1):
                    f = open('result_reward_change.txt', 'w')
                    f.write(f"{currPlayer.name}\n")
                else:
                    f = open('result_reward_change.txt', 'a')
                    f.write(f"{currPlayer.name}\n")
    ...
    def reset(self):
        # print(f"self.diceStats:{self.diceStats}")

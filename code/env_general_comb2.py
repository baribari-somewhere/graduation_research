...
class Env_General_comb2(gym.Env):
    ...
    def step(self, action_index: int):
        ...
        dev = self.DV_sort(self.figure, dev_list)
        # print(f"dev:{dev}")
        ...
        #     list2.append(i)
        # print(f"resource_before:{list2}")
        resource = self.RESOURCE_sort(self.figure, my_resource)
        # print(f"resource_after:{resource}")

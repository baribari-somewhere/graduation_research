...
model = DQN.load("./save_weights_test_random_20230112_conti8000000/rl_model_12000000_steps.zip",
                 env, verbose=0, tensorboard_log="log", device="auto")
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_test_random_20230112_conti8000000-12000000")

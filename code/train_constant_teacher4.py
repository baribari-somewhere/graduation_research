...
#env = Env_Catan()
env = Env_Constant_Catan_Teacher3()
...
model = DQN.load("./save_weights_teacher_20230109_conti94000000/rl_model_42000000_steps",
                 env, verbose=1, tensorboard_log="log", device="auto")
...
checkpoint_callback = CheckpointCallback(
    ...
    save_freq=setting.default_save_freq, save_path="save_weights_teacher_20230109_conti94000000-42000000")
